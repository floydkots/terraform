...
// module output values), set the type constraint to cty.DynamicPseudoType
// in order to save type information as part of the value, and then also pass
// cty.DynamicPseudoType to method Decode to recover the original value.
//
